                                ...
                                <table border="0"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <table border="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:140px;"><img height="140"
                                                                src="{{ $agent->profile->image ? $agent->profile->image : 'https://www.w3schools.com/w3images/avatar2.png' }}"
                                                                style="border:0;border-radius:50%;display:block;outline:none;text-decoration:none;height:140px;width:100%;font-size:13px;"
                                                                width="140"></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <tr>
                                        <td align="center"
                                            style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div
                                                style="font-family:Roboto, sans-serif;font-size:25px;line-height:33px;text-align:center;color:#6B79ED;">
                                                {{ $agent->name }}</div>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <table cellpadding="0"
                                                ...
                                                width="400"
                                                border="0"
                                                style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:400px;border:none;">
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="position: relative;"
                                                        class="star-text"><span
                                                            style="position: absolute; top: 17%; transform: translateX(2px)">Awful</span>
                                                    </td>
                                                    <td style="position: relative;"
                                                        class="star-text"><span
                                                    ...
                                                    <td style="position: relative;"
                                                        class="star-text"><span
                                                            style="position: absolute; top: 17%; transform: translateX(-10px)">Pretty
                                                            Good</span></td>
                                                    <td style="position: relative;"
                                                        class="star-text"><span
                                                            style="position: absolute; top: 17%; transform: translateX(-6px)">Fantastic!</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                        ...
                        <td style="direction:ltr;font-size:0px;padding:0px;text-align:center;">
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0"
                                    ...
                                    <tr>
                                        <td align="left"
                                            style="font-size:0px;padding:10px 25px;padding-left:110px;word-break:break-word;">
                                            <div
                                                style="font-family:Roboto, sans-serif;font-size:16px;line-height:33px;text-align:left;text-decoration:underline;color:gray;">
                                                Report unsafe behaviour</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center"
                                            style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div
                                                style="font-family:Roboto, sans-serif;font-size:16px;line-height:33px;text-align:center;color:gray;">
                                                Copyright @Agent Reviews 2019</div>
                                        </td>
                                    </tr>
                                </table>
                            </div>

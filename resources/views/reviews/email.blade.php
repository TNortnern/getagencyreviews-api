                                        ...
                                        <td align="center"
                                            ...
                                            <div
                                                ...
                                                <a style="color: #464646; text-decoration: none;"
                                                    href="{{ env('CLIENT_URL') }}/reviews?rating=1-{{ $email->id }}-{{ $agent->id }}">
                                ...
                                <table border="0"
                                    ...
                                    <tr>
                                        <td style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <!--[if mso | IE]>
        <table
           align="center" border="0" cellpadding="0" cellspacing="0" style="border-top:solid 1px gray;font-size:1;margin:0px auto;width:389px;" role="presentation" width="389px"
        >
          <tr>
